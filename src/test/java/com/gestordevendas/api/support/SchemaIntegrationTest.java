...
class SchemaIntegrationTest extends PostgresIntegrationTest {
    ...
    void flywayCreatesIdentityAndTenancySchema() {
        ...
        assertTableExists("cliente_produto_oculto");
        assertTableExists("pedidos_cliente");
        assertTableExists("pedido_cliente_itens");
        assertThat(jdbcTemplate.queryForObject("select count(*) from flyway_schema_history where version = '3'", Integer.class))
            .isEqualTo(1);
        assertThat(jdbcTemplate.queryForObject("select count(*) from flyway_schema_history where version = '4'", Integer.class))
            .isEqualTo(1);
        assertThat(jdbcTemplate.queryForObject(
            "select count(*) from information_schema.columns where table_schema='public' and table_name='clientes' and column_name='pedido_token' and is_nullable='NO'", Integer.class))
            .isEqualTo(1);
